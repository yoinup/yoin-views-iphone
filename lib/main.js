...
require('yoin-views-iphone/views/uis/activity/base');
require('yoin-views-iphone/views/uis/activity/comment');
require('yoin-views-iphone/views/uis/activity/get_invitation');
require('yoin-views-iphone/views/uis/activity/like');
require('yoin-views-iphone/views/uis/activity/send_invitation');
