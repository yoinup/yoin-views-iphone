...
Yvi.VenueNearUserSquareImageView = Yn.TapSquareImageView.extend({
...
Yvi.UnTapVenueBoxProductSwipeView = Yn.SwipeView.extend({
...
Yvi.VenueBoxProductSwipeView = Yvi.UnTapVenueBoxProductSwipeView.extend(Yn.Btap, {
...
Yvi.VenueBoxView = Em.View.extend({
  ...
  hasPeople: Em.computed(function() {
    ...
    if ( this.get('hasSelectedUser') || this.get('disableTap') ) return false;
    var length = this.get('people.length');
