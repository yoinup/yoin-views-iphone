...
Yvi.TabPane = Ember.Mixin.create({
...
Yvi.IndependentTabPane = Ember.Mixin.create(Yvi.TabPane, {
...
Yvi.IndependentTabPaneView = Em.View.extend( Yvi.IndependentTabPane, {

});

Yvi.TabMainView = Em.View.extend({
  ...
  createChildView: function(view, attrs) {
    ...
    if ( !Yvi.TabPane.detect(result)  ) {
      Em.mixin(result, Yvi.TabPane);
    }
    return result;
  ...
  appendTabPaneView: function(view) {
    ...
    Em.assert('appending a not Yvi.TabPane', Yvi.TabPane.detect(view) );
...
Yvi.TabOption = Em.Mixin.create( Yn.Btap, {
...
Yvi.IconTabOptionView = Em.View.extend( Yn.Icon, Yvi.TabOption, {
