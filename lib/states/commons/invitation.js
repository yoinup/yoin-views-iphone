  ...
  _localInvitationUpdate: function(sm, invitation) {
    ...
    if ( invitation.get('rejected') ) {
      ...
      invitation.one('didUpdateError', function() {
        ...
        App.inboxInvitationsController.get('content').pushObject(invitation);
        App.archivedInvitationsController.get('content').removeObject(invitation);
      });

      App.inboxInvitationsController.get('content').removeObject(invitation);
      App.archivedInvitationsController.get('content').pushObject(invitation);
      this.doBack(sm);
